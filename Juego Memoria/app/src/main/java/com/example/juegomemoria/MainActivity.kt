...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //posiciones aleatorias de los elementos de un arreglo
    ...
    private fun setUpUI(){
        ...
        tv_player2.setTextColor(Color.GRAY)
    ...
    private fun cargarCartas(){
        ...
        image14=R.drawable.ic_flight_black
        image15=R.drawable.ic_walk_24dp


        image21=R.drawable.ic_bike
        image22=R.drawable.ic_boat
        image23=R.drawable.ic_car
        image24=R.drawable.ic_flight_black
        image25=R.drawable.ic_walk_24dp
    }
    ...
    private fun asignarImagenalaCarta(image:ImageView,carta:Int){
        ...
        if(numeroCarta == 1) {
            ...
            //instanciar objeto de la clase handler(manejador/controlador para envio y proceso de mensajes)
            var handler=Handler()
            //detener durante un segundo el resto de funcionalidades creadas y ejecutar unicamente este evento
    ...
    private fun comprobarCorrecto(){
        if(primeraCarta == segundaCarta){
            ...
            if(turno == 1){
                puntosPlayer1++
                tv_player1.setText("Jugador 1: " + puntosPlayer1)
            }else{
                puntosPlayer2++
                tv_player2.setText("Jugador 2: " + puntosPlayer2)
            }
        }else{
            ...
            if(turno == 1){
                turno = 2
                tv_player1.setTextColor(Color.GRAY)
                tv_player1.setTypeface(null, Typeface.NORMAL)
                tv_player2.setTextColor(Color.RED)
                tv_player1.setTypeface(null, Typeface.BOLD)
            }else{
                turno = 1
                tv_player1.setTextColor(Color.GREEN)
    ...
    private fun finPartida(){
        if(im11.visibility == View.INVISIBLE &&
            ...
            alertDialog.setMessage("Jugador 1: " + puntosPlayer1 + "\nJugador 2: " + puntosPlayer2)
